...
BRANCH_NAME=hyper_diffusion_planner_nuplan
...
python $NUPLAN_DEVKIT_ROOT/nuplan/planning/script/run_simulation.py \
    ...
    planner.hyper_diffusion_planner.ckpt_path=$CKPT_FILE \
    ...
    hydra.searchpath="[pkg://hdp_nuplan.config.scenario_filter, pkg://hdp_nuplan.config, pkg://nuplan.planning.script.config.common, pkg://nuplan.planning.script.experiments  ]"