...
from hdp_nuplan.utils.train_utils import set_seed, save_model, resume_model
...
def get_args():
    ...
    parser.add_argument('--planning_hybrid_loss', type=float, help='coefficient of planning hybrid loss (default: 0.01)', default=0.01)
